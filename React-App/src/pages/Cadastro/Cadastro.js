    ...
    return(
        <div id="Pg2" className ="d-flex flex-column justify-content-center align-items-center" >
            ...
            <div className="d-flex flex-column p-5 ml-2">
                ...
                <input type="nome" placeholder="" value={nome} onChange={handleOnChangeNome} className="input-Cadastro"></input>
                <label for="senha" className="label-Cadastro">Senha</label>
                <input type="password" placeholder="" value={senha} onChange={handleOnChangeSenha} className="input-Cadastro"></input>
            </div>

            <div className="d-flex flex-column p-5 ml-2">
                <label for="email" className="label-Cadastro">Email</label>
                <input type="email" placeholder="" value={email} onChange={handleOnChangeEmail} className="input-Cadastro"></input>
                <label for="senha" className="label-Cadastro">Confirmar Senha</label>
                <input type="password" placeholder="" value={confirmarSenha} onChange={handleOnChangeConfirmarSenha} className="input-Cadastro"></input>
            </div>
            </div>
